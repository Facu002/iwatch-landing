    ...
    return (
        <div className='Home-container'>
            ...
            <div className='Home-container-row'>
                <CartVertical key={'water'} identityclass={"water"} media={water} secondaryColor={"#0095D0"}
                bntStrokeColor={"#000"}
                cartTitle={["Al ", <span key={'water'}>agua</span>, <br />,"como si nada."]}
                ...
                /> 
                <CartVertical key={'fitness'}
                identityclass={"fitness"} media={fitness} secondaryColor={"#44B200"}
                bntStrokeColor={"#000"}
                cartTitle={[<span key={'fitness'}>Entrénate</span>, " para",<br />,"desafiar tus límites."]}
            ...
            <div className="Home-container-row">
                <CartVertical key={'attention'} identityclass={"attention"} video={attention}  secondaryColor={"#158D89"}
                bntStrokeColor={"#fffff"}
                cartTitle={["Pleno equilibrio", <br />, "con ", <span key={'attention'}>Atención <br /> Plena</span>,"."]}
                ...
                />
                <CartVertical key={'emergency'} identityclass={"emergency"} media={emergency}  secondaryColor={"#e45d50"}
                bntStrokeColor={"#000"}
                cartTitle={["Pide ", <span key={'emergency'}>ayuda</span>, <br />,"cuando más", <br />, "la necesitas."]}
            ...
            <div className="Home-container-row">
                <CartVertical key={'sleep'} identityclass={"sleep"} media={sleep}  secondaryColor={"#158D89"}
                bntStrokeColor={"#fffff"}
                cartTitle={["Está pendiente de ti.", <br />,"Día y " ,<span key={'sleep'}>noche</span>,"."]}
                ...
                />
                <CartVertical key={'call'} identityclass={"call"} media={call}  secondaryColor={"#158D89"}
                bntStrokeColor={"#fffff"}
                cartTitle={["La libertad te", <br />, "está ", <span key={'call'}>llamando</span>,"."]}
                overlayTitle={["Pleno equilibrio con Atención Plena."]}
                overlayText={["La app Atención Plena te ayuda a aliviar el estrés de todos los días, concentrarte mejor y prepararte mentalmente para enfrentar nuevos desafíos. Todo a través de una serie de ejercicios de respiración que invitan a relajarse y encontrar el equilibrio reflexionando sobre un tema simple e inspirador."]}
                />
            ...
            <div className="Home-container-row">
                <CartVertical key={'apps'} identityclass={"apps"} media={apps}  secondaryColor={"#0255fb"}
                bntStrokeColor={"#000"}
                cartTitle={["Miles de ", <span key={'apps'}>apps </span> , "a un", <br />,"toque de distancia."]}
                ...
                />
                <CartVertical key={'music'} identityclass={"music"} media={music}  secondaryColor={"#fa2d48"}
                bntStrokeColor={"#000"}
                cartTitle={[<span key={'music'}>Música </span>,"y ",<span>podcasts </span>,<br />, "para mantener activos tus oídos."]}
                overlayTitle={["Pide ayuda cuando más la necesitas."]}
                overlayText={["El Apple Watch SE puede detectar si sufriste una caída fuerte y contactar a los servicios de emergencia en caso de que no puedas moverte.3 Y ahora Detección de Caídas funciona cuando estás usando la app Entrenamiento.4 También puedes recibir asistencia inmediata ante una emergencia, incluso en el extranjero, con sólo mantener presionado el botón lateral.5"]}
                />
            </div>
            ...
            <div className="Home-container-row">
                <CartVertical key={'wallpapers'} identityclass={"wallpapers"} media={wallpapers}  secondaryColor={"#C67804"}
                bntStrokeColor={"#000"}
                cartTitle={[<span key={'wallpapers'}>Caratulas </span>,"tan", <br />, "increíbles que te ", <br />, "costará escoger una."]}
                ...
                />
                <CartVertical key={'straps'} identityclass={"straps"} media={call}  secondaryColor={"#D61739"}
                bntStrokeColor={"#000"}
                cartTitle={["Un desfile", <br />, "de ", <span key={'call'}>correas</span>,"."]}
